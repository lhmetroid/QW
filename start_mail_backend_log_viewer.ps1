...
$Host.UI.RawUI.WindowTitle = "QW Mail-only Backend $Port logs (viewer only)"

Write-Host "============================================================"
Write-Host "QW Mail-only Backend Log Viewer"
...
Write-Host "WeChat-related background polling is EXPLICITLY DISABLED."
